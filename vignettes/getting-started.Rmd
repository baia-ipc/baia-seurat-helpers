...
single-cell infrastructure. It provides generic helper code useful across
scRNA-seq and multi-omics projects:
...
Use this package when the problem falls into one of these function families:
